...
# قائمة الأحياء للمساعدة في البحث
KNOWN_DISTRICTS = [
...
# قاموس توحيد الأعمدة (لاحظ أننا نربط نوع العقار بـ نوع_العقار_الخام)
COLUMN_MAPPING = {
        ...
        try:
            ...
            for file in results.get('files', []):
                ...
                try:
                    ...
                    # 2. تصنيف العقار (بناءً على صورتك)
                    ...
                    # 🔥 التعديل الهام: إضافة 'نوع_العقار_الخام' للقائمة النهائية
                    cols = ['Source_File', 'Data_Category', 'الحي', 'السعر', 'المساحة', 'سعر_المتر', 'نوع_العقار', 'نوع_العقار_الخام']
                    # نختار فقط الأعمدة الموجودة لتجنب الأخطاء
